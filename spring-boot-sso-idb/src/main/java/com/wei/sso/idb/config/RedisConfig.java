package com.wei.sso.idb.config;


import com.wei.sso.idb.util.RedisOP;
import com.wei.sso.idb.util.RedisUtil;
...
public class RedisConfig {
    @Value("${spring.demo.host}")
    private String host;
    @Value("${spring.demo.database}")
    private Integer database;
    @Value("${spring.demo.port}")
    private Integer port;
    @Value("${spring.demo.password}")
    private String pwd;

    @Bean
    @ConfigurationProperties(prefix = "spring.demo.jedis.pool")
